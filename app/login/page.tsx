      ...
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-zinc-800/50">
        <div className="p-8">
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-zinc-100">Welcome Back</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-2">Manage your finesse with ease</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isLoading ? <Loader2 className="w-6 h-6 animate-spin mr-2" /> : <LogIn className="w-5 h-5 mr-2" />}
